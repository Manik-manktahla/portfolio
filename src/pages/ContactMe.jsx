  ...
  return (
    <div className="contact-main-container" id="contact">
        ...
        <Grid container xs={12} spacing={0}>
          ...
          <Grid item sx={1}>
          <Divider className='contact-divider contact-vertical-divider' orientation="vertical"  />
          </Grid>
          <Grid className='contact-subContainer' item xs={5} className='contact-personal-container'>
